...
def predict_and_save_res(args, tokenizer, dataset):
    ...
    for output in outputs:
        ...
        if marker in decoded_output:
            ...
            extracted_text = decoded_output[
                marker_index:
            ].strip()  # Extract text after marker
        else:
            extracted_text = ""  # If the marker is not found, return empty string
...
def run(args):
    ...
    if args.task == "train":
        ...
        train(args, tokenizer, train_dataset)
    else:
        ...
        return predict_and_save_res(args, tokenizer, test_dataset)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gradient_accumulation_steps", default=4, help="gradient_accumulation"
    )
